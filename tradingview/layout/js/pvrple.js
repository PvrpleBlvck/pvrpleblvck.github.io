...
//   function (t) {
//     ! function (t) {
//       t.SymbolClick = "tv-widget-symbol-click", t.WidgetLoad = "tv-widget-load", t.ResizeIframe = "tv-widget-resize-iframe"
//     }(t.Names || (t.Names = {}))
//   }(o || (o = {}));
//   var s = ["locale", "symbol"],
//     c = function () {
...
//     var h, d = isNaN(this.settings.height) ? this.settings.height : this.settings.height + "px",
...
//     this.script.parentNode && g ? this.iframeContainer = this.script.parentNode : this.iframeContainer = document.createElement("div"), this.iframeContainer.style.width = p, this.iframeContainer.style.height = d, this.iframeContainer.appendChild(((h = document.createElement("style")).innerHTML = "\n\t.tradingview-widget-copyright {\n\t\tfont-size: 13px !important;\n\t\tline-height: 32px !important;\n\t\ttext-align: center !important;\n\t\tvertical-align: middle !important;\n\t\tfont-family: 'Trebuchet MS', Arial, sans-serif !important;\n\t\tcolor: " + e["color-gull-gray"] + " !important;\n\t}\n\n\t.tradingview-widget-copyright .blue-text {\n\t\tcolor: " + e["color-brand"] + " !important;\n\t}\n\n\t.tradingview-widget-copyright a {\n\t\ttext-decoration: none !important;\n\t\tcolor: " + e["color-gull-gray"] + " !important;\n\t}\n\n\t.tradingview-widget-copyright a:visited {\n\t\tcolor: " + e["color-gull-gray"] + " !important;\n\t}\n\n\t.tradingview-widget-copyright a:hover .blue-text {\n\t\tcolor: " + e["color-scooter"] + " !important;\n\t}\n\n\t.tradingview-widget-copyright a:active .blue-text {\n\t\tcolor: " + e["color-curious-blue"] + " !important;\n\t}\n\n\t.tradingview-widget-copyright a:visited .blue-text {\n\t\tcolor: " + e["color-brand"] + " !important;\n\t}\n\t", h));
//     var m = c && !this.settings.whitelabel,
//       u = this.hasCopyright ? "calc(" + d + " - 32px)" : d;
//     this.settings.utm_source = location.hostname, this.settings.utm_medium = l ? "widget_new" : "widget", this.settings.utm_campaign = this.widgetUtmName, this.iframe = this._createIframe(u, p, n, r, a.id);
...
//   }, Object.defineProperties(c.prototype, l), new(function (t) {
//     function e() {
...
//       return ["belowLineFillColorFalling", "belowLineFillColorGrowing", "customer", "exchange", "gridLineColor", "height", "isTransparent", "colorTheme", "largeChartUrl", "locale", "plotLineColorFalling", "plotLineColorGrowing", "scaleFontColor", "showChart", "symbolActiveColor", "symbolDescriptionColor", "symbolSeparatorColor", "symbolShortNameColor", "tickerColorFalling", "tickerColorGrowing", "whitelabel", "width"]
